...
# Iterate over all relevant fossil specimens
  ...
  if (plot.specimens) {
    ...
    for (mName in names(mList)) {
      ...
      if (mName %in% c('PRA.NAA.Prin1.vis.nm', 'glab.prot.neu.nm')) {
        m$value <- -m$value  # Flip sign to match correlation direction
      }
    ...
    ggsave(filename = paste0(specimen, '_Fig1.svg'),
